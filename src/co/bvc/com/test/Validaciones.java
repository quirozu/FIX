		...
		for (int z = 0; z < cad.size(); z++) {
			...
			case "1":
				if (cad.get(z).split("=")[1].equals(account)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "22":
				if (cad.get(z).split("=")[1].equals(securityIdSource)) {
					...
					System.out.println(" securityIdSource (" + clavePrima + ") MSG: " + cad.get(z).split("=")[1]
							+ " BD " + securityIdSource);
					contadorMalos++;
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							securityIdSource, id_Escenario, idCase, idSecuencia, clavePrima);
...
//				break;
			case "55":
				if (cad.get(z).split("=")[1].equals(symbol)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							symbol, id_Escenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
...
//				break;
			case "762":
				if (cad.get(z).split("=")[1].equals(secSubTypec)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							secSubTypec, id_Escenario, idCase, idSecuencia, clavePrima);
			...
			case "8":
				if (cad.get(z).split("=")[1].equals(beginString)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							beginString, id_Escenario, idCase, idSecuencia, clavePrima);
				} else {
			...
			case "453":
				if (cad.get(z).split("=")[1].equals(noPartyId)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							noPartyId, id_Escenario, idCase, idSecuencia, clavePrima);
				} else {
			...
			case "49":
				if (cad.get(z).split("=")[1].equals(SenderCompID)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							SenderCompID, id_Escenario, idCase, idSecuencia, clavePrima);
				} else {
		...
		for (int z = 0; z < cad.size(); z++) {
			...
			case "1":
				if (cad.get(z).split("=")[1].equals(account)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "632":
				if (cad.get(z).split("=")[1].equals(bidyield)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							bidyield, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
			...
			case "134":
				if (cad.get(z).split("=")[1].equals(bidSize)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							bidSize, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
			...
			case "634":
				if (cad.get(z).split("=")[1].equals(offerYield)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							offerYield, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
...
//				break;
			...
			case "55":
				if (cad.get(z).split("=")[1].equals(symbol)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							symbol, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
							" RQ_SYMBOL (" + clavePrima + ") MSG: " + cad.get(z).split("=")[1] + " BD: " + symbol);
					DataAccess.cargarLogsFallidos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "762":
				if (cad.get(z).split("=")[1].equals(secSubType)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							secSubType, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(" RQ_SECSUBTYPE (" + clavePrima + "): MSG" + cad.get(z).split("=")[1] + " BD: "
							+ secSubType);
					DataAccess.cargarLogsFallidos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "35":
				if (cad.get(z).split("=")[1].equals(msgType)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							msgType, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
							" RQ_MSGTYPE (" + clavePrima + ") MSG: " + cad.get(z).split("=")[1] + " BD: " + msgType);
					DataAccess.cargarLogsFallidos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "135":
				if (cad.get(z).split("=")[1].equals(OfferSize)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							OfferSize, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
			...
			case "453":
				if (cad.get(z).split("=")[1].equals(noPartyId)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							noPartyId, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(
			...
			case "22":
				if (cad.get(z).split("=")[1].equals(SecurityIDSource)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							SecurityIDSource, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(" SecurityIDSource (" + clavePrima + ") MSG: " + cad.get(z).split("=")[1]
							+ " BD: " + SecurityIDSource);
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "49":
				if (cad.get(z).split("=")[1].equals(SenderCompID)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							SenderCompID, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(" SenderCompID (" + clavePrima + ") MSG: " + cad.get(z).split("=")[1] + " BD: "
							+ SenderCompID);
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
			...
			case "8":
				if (cad.get(z).split("=")[1].equals(beginString)) {
					...
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
							beginString, idEscenario, idCase, idSecuencia, clavePrima);
				} else {
					System.out.println(" beginString (" + clavePrima + ") MSG: " + cad.get(z).split("=")[1] + " BD: "
							+ beginString);
					DataAccess.cargarLogsExitosos(messageIn, datosCache.getIdEjecucion(), cad.get(z).split("=")[1],
		...
		for (int i = 0; i < cad.size(); i++) {
			...
			case "1":
				if (cad.get(i).split("=")[1].equals(account)) {
					...
					DataAccess.cargarLogsExitosos(qr, datosCache.getIdEjecucion(), account, cad.get(i).split("=")[1],
			...
			case "298":
				if (cad.get(i).split("=")[1].equals(quoteCancelType)) {
					...
					DataAccess.cargarLogsFallidos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							quoteCancelType, idEscenario, idCase, idSecuencia, valor);
					contadorMalos++;
				}
				break;
			case "135":
				if (cad.get(i).split("=")[1].equals(OfferSize)) {
					...
					DataAccess.cargarLogsFallidos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1], OfferSize,
							idEscenario, idCase, idSecuencia, valor);
					contadorMalos++;
				}
				break;
			...
			case "297":
				if (cad.get(i).split("=")[1].equals(quoteStatus)) {
					...
					DataAccess.cargarLogsFallidos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							quoteStatus, idEscenario, idCase, idSecuencia, valor);
					contadorMalos++;
				}
				break;
			...
			case "22":
				if (cad.get(i).split("=")[1].equals(SecurityIDSource)) {
					...
					System.out.println(" SecurityIDSource (" + valor + ") MSG: " + cad.get(i).split("=")[1] + " BD: "
							+ SecurityIDSource);
					DataAccess.cargarLogsFallidos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							SecurityIDSource, idEscenario, idCase, idSecuencia, valor);
					contadorMalos++;
				}
				break;
			case "453":
...
//				break;
			case "49":
				if (cad.get(i).split("=")[1].equals(SenderCompID)) {
					...
					DataAccess.cargarLogsExitosos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							SenderCompID, idEscenario, idCase, idSecuencia, valor);
				} else {
					System.out.println(
							" SenderCompID (" + valor + ") MSG: " + cad.get(i).split("=")[1] + " BD: " + SenderCompID);
					DataAccess.cargarLogsExitosos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							SenderCompID, idEscenario, idCase, idSecuencia, valor);
			...
			case "8":
				if (cad.get(i).split("=")[1].equals(beginString)) {
					...
					DataAccess.cargarLogsExitosos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							beginString, idEscenario, idCase, idSecuencia, valor);
				} else {
					System.out.println(
			...
			case "38":
				if (cad.get(i).split("=")[1].equals(order)) {
					...
					System.out
							.println("RS_ORDERQTY (" + valor + ") MSG: " + cad.get(i).split("=")[1] + " BD: " + order);
	...
	public void validarOcho(AutFixRfqDatosCache datosCache, Message message) throws SQLException, FieldNotFound {
		...
		String execType = null, orderStatus = null, leaveQty = null, orderQty = null, price = null,
				grosstradeamt = null, nopartyIds = null, secSubtype = null, symbol = null, SenderCompID = "EXC",
				beginString = "FIX.4.4", SecurityIDSource = "M", senderSubId = null, dirtyPrice = null,
				partyIdsSource = null, idCase = null, idEscenario = null, targetComId = null, targetSubId = null,
				ciordId = null, execId = null, orderId = null, reforderId = null, cumQTy = null, fillYield = null,
				trdmatchId = null, account = null;
		int side = 0, reforderIdsCr = 0, idSecuencia = 0;

		// Valores para grupos repetitivos de parties
		String setLocVal = null, execFirmVal = null, execTraderVal = null, contraTraderVal = null, contraFirmVal = null,
				enterTraderVal = null, enterTraderVal1 = null;
		int setLoc = 0, execFirm = 0, execTrader = 0, contraTrader = 0, contraFirm = 0, enterTrader = 0;

		// String ER_SETTLOCVAL 10, ER_EXECFIRMVAL 1, ER_EXECTRADERVAL 12,
		// ER_CONTRATRADERVAL 37, ER_CONTRAFIRMVAL 17, ER_ENTERTRADERVAL 36
		...
		while (resultset.next()) {
			...
			reforderId = BasicFunctions.getQuoteId();
			targetComId = resultset.getString("ID_AFILIADO");
			targetSubId = resultset.getString("RQ_TRADER");
...
//			side = resultset.getString("ER_SIDE");
			...
			reforderIdsCr = resultset.getInt("ER_REFORDERIDSCR");
			...
			if (message.getHeader().getString(TargetCompID.FIELD).equals(BasicFunctions.getIniciator())) {
				...
				side = resultset.getInt("ER_SIDE");

			} else {
				// Si la session no es la del iniciador se invierten firma y trader por
				// contrafirma y contratrader respectivamente.
				execFirm = resultset.getInt("ER_EXECFIRM"); // 1
				...
				contraTrader = resultset.getInt("ER_CONTRATRADER"); // 37
				contraTraderVal = resultset.getString("ER_EXECTRADERVAL"); // 3-2=1 3-1=2
				side = 3 - resultset.getInt("ER_SIDE"); // 54
				reforderIdsCr = resultset.getInt("ER_REFORDERIDSCR") + 1;
			}
...
//				break;
			...
			case "1623":
				if (valorFix.equals(fillYield)) {
					...
					System.out.println(" ER_FILLYIELD (" + etiquetaFix + ") MSG: " + valorFix + " BD: " + fillYield);
			...
			case "14":
				if (valorFix.equals(cumQTy)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), cumQTy, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" ER_CUMQTY (" + etiquetaFix + ") MSG: " + valorFix + " BD: " + cumQTy);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, cumQTy, idEscenario,
							idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "22":
				if (valorFix.equals(SecurityIDSource)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), SecurityIDSource, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(
							" SecurityIDSource (" + etiquetaFix + ") MSG: " + valorFix + " BD: " + SecurityIDSource);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, SecurityIDSource,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "1080":
				if (valorFix.equals(reforderId)) {
					...
					System.out.println(" ER_REFORDERID (" + etiquetaFix + ") MSG: " + valorFix + " BD " + reforderId);
					contadorMalos++;
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, reforderId,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				}
				break;
			case "37":
				if (valorFix.equals(orderId)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), orderId, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" ER_ORDERID (" + etiquetaFix + ") MSG: " + valorFix + " BD " + orderId);
					contadorMalos++;
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, orderId, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				}
				break;
//			case "17":
			...
			case "11":
				...
				if (message.getHeader().getString(TargetCompID.FIELD).equals(BasicFunctions.getIniciator())) {
					if (message.getString(11).equals(mensajeAJ)) {
						...
						DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), mensajeAJ, valorFix,
								idEscenario, idCase, idSecuencia, etiquetaFix);
					} else {
						DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, mensajeAJ,
								idEscenario, idCase, idSecuencia, etiquetaFix);
					}

				} else {
					if (message.getString(11).equals(mensajeS)) {
						DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), mensajeS, valorFix,
								idEscenario, idCase, idSecuencia, etiquetaFix);

					} else {
						DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, mensajeS,
								idEscenario, idCase, idSecuencia, etiquetaFix);
...
//				break;
			case "49":
				if (valorFix.equals(SenderCompID)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), SenderCompID, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" SenderCompID (" + etiquetaFix + "): MSG" + valorFix + " BD: " + SenderCompID);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, SenderCompID,
							idEscenario, idCase, idSecuencia, etiquetaFix);
			...
			case "1":
				if (valorFix.equals(account)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), account, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" account (" + etiquetaFix + "): MSG" + valorFix + " BD: " + account);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, account, idEscenario,
							idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "8":
				if (valorFix.equals(beginString)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), beginString, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" beginString (" + etiquetaFix + "): MSG" + valorFix + " BD: " + beginString);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), beginString, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "150":
				if (valorFix.equals(execType)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), execType, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" ER_EXECTYPE (" + etiquetaFix + "): MSG" + valorFix + " bd: " + execType);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, execType, idEscenario,
							idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "39":
				if (valorFix.equals(orderStatus)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), orderStatus, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" ER_ORDSTATUS (" + etiquetaFix + "): MSG" + valorFix + " BD: " + orderStatus);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, orderStatus,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "54":
				if (valorFix.equals(Integer.toString(side))) {
					contadorBuenos++;

					cadenaDeMensaje("ER_SIDE", etiquetaFix, Integer.toString(side));

					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), Integer.toString(side),
							valorFix, idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(
							" ER_SIDE (" + etiquetaFix + "): MSG" + valorFix + " BD: " + Integer.toString(side));
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix,
							Integer.toString(side), idEscenario, idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "151":
				if (valorFix.equals(leaveQty)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), leaveQty, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" ER_LEAVEQTY (" + etiquetaFix + "): MSG" + valorFix + " BD: " + leaveQty);
					contadorMalos++;
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, leaveQty, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				}
				break;
			case "38":
				if (valorFix.equals(orderQty)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), orderQty, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					System.out.println(" ER_ORDERQTY (" + etiquetaFix + "): MSG" + valorFix + " bd: " + orderQty);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, orderQty, idEscenario,
							idCase, idSecuencia, etiquetaFix);
					contadorMalos++;
				}
				break;
			case "44":
				if (valorFix.equals(price)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), price, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, price, idEscenario,
							idCase, idSecuencia, etiquetaFix);
...
//				break;
			case "453":
				if (valorFix.equals(nopartyIds)) {
					...
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, nopartyIds,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					System.out.println(" ER_NOPARTYIDS (" + etiquetaFix + "): MSG" + valorFix + " BD: " + nopartyIds);
					contadorMalos++;
				}
				break;
			case "762":
				if (valorFix.equals(secSubtype)) {
					...
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, secSubtype,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					System.out.println(" ER_SECSUBTYPE (" + etiquetaFix + "): MSG" + valorFix + " BD: " + secSubtype);
					contadorMalos++;
				}
				break;
			case "1081":
				if (valorFix.equals(Integer.toString(reforderIdsCr))) {
					contadorBuenos++;

					cadenaDeMensaje("ER_REFORDERIDSCR", etiquetaFix, Integer.toString(reforderIdsCr));

					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), Integer.toString(reforderIdsCr),
							valorFix, idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix,
							Integer.toString(reforderIdsCr), idEscenario, idCase, idSecuencia, etiquetaFix);
					System.out.println(
							" ER_REFORDERIDSCR (" + etiquetaFix + "): MSG" + valorFix + " BD: " + reforderIdsCr);
					contadorMalos++;
				}
				break;
			case "55":
				if (valorFix.equals(symbol)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), symbol, valorFix, idEscenario,
							idCase, idSecuencia, etiquetaFix);
				} else {
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, symbol, idEscenario,
							idCase, idSecuencia, etiquetaFix);
			...
			case "50":
				if (valorFix.equals(senderSubId)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), senderSubId, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, senderSubId,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					System.out.println(" ER_SENDERSUBID (" + etiquetaFix + "): MSG" + valorFix + " BD: " + senderSubId);
					contadorMalos++;
				}
				break;
			case "20102":
				if (valorFix.equals(dirtyPrice)) {
					...
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, dirtyPrice,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					System.out.println(" ER_DIRTYPRICE (" + etiquetaFix + "): MSG" + valorFix + " BD: " + dirtyPrice);
					contadorMalos++;
				}
				break;
			case "447":
				if (valorFix.equals(partyIdsSource)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), partyIdsSource, valorFix,
							idEscenario, idCase, idSecuencia, etiquetaFix);
				} else {
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), valorFix, partyIdsSource,
							idEscenario, idCase, idSecuencia, etiquetaFix);
					System.out.println(
							" ER_PARTYIDSOURCE (" + etiquetaFix + "): MSG" + valorFix + " BD: " + partyIdsSource);
					contadorMalos++;
				}
				break;
		...
		while (it.hasNext()) {
			...
			case 1:
				...
				if (firm.equals(execFirmVal)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), firm, execFirmVal, idEscenario,
							idCase, idSecuencia, "448");
				} else {
					System.out.println(" PartyID (448). MSG: " + firm + " - DB: " + execFirmVal);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), firm, execFirmVal, idEscenario,
							idCase, idSecuencia, "448");
					contadorMalos++;
				}
			...
			case 10:
				...
				if (firm.equals(setLocVal)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), firm, setLocVal, idEscenario,
							idCase, idSecuencia, "448");
				} else {
					System.out.println(" PartyID (448). MSG: " + firm + " - DB: " + setLocVal);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), firm, setLocVal, idEscenario,
							idCase, idSecuencia, "448");
					contadorMalos++;
				}
			...
			case 36:
				...
				if (key.equals(enterTrader)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), key.toString(),
							enterTrader + "", idEscenario, idCase, idSecuencia, "452");
				} else {
					System.out.println(" PartyRole (452). MSG: " + key + " - DB: " + enterTrader);
					DataAccess.cargarLogsFallidos(message, datosCache.getIdEjecucion(), key.toString(),
							enterTrader + "", idEscenario, idCase, idSecuencia, "452");
					contadorMalos++;
				}
			...
			case 37:
				...
				if (key.equals(contraTrader)) {
					...
					DataAccess.cargarLogsExitosos(message, datosCache.getIdEjecucion(), key.toString(),
							contraTrader + "", idEscenario, idCase, idSecuencia, "452");
				} else {
...
//				break;
	...
	public void validarAG(AutFixRfqDatosCache datosCache, Message qr) throws SQLException, FieldNotFound {
		...
		ArrayList<String> cad = FragmentarCadena(cadena);
		String valor;
		String beginString = "FIX.4.4", senderCompId = "EXC", targetCompId = null, targetSubId = null, text = null,
		...
		for (int i = 0; i < cad.size(); i++) {
			...
			case "762":
				if (cad.get(i).split("=")[1].equals(securitySubType)) {
					...
					DataAccess.cargarLogsExitosos(qr, datosCache.getIdEjecucion(), cad.get(i).split("=")[1],
							securitySubType, idEscenario, idCase, idSecuencia, valor);
				} else {
