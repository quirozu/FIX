...
//	   }
	...
	public void enviarMensaje(ResultSet resultSet, long Idejecucion, String quoteReqId)
...
//			   DataAccess.getQuery(queryPersistencia);
	...
	public void validarR(SessionID sessionId, quickfix.Message messageIn)
	...
	public void validarS(SessionID sessionId, quickfix.Message messageIn)
		...
		if (DataAccess.validarContinuidadEjecucion(IdAfiliado)) {
			...
			// ejecutarSiguientePaso(datosCache.getIdCaseseq(), datosCache.getIdEjecucion(),
			// idQuoteReq);
	...
	public void ejecutarSiguientePaso(int idCaseSeqActual, long idEjecucion, String quoteReqId)
			throws SQLException, SessionNotFound, InterruptedException {
...
//			   resultSet.first();
	...
	public static void printMessage(String typeMsg, SessionID sessionId, quickfix.Message message2)
